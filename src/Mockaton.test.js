...
import { parseFilename, nameForAuto500 } from './Filename.js'
...
describe('500', () => {
	it('autogenerated in-memory 500', async () => {
		await commander.select(nameForAuto500('api/alternative', 'GET'))
	...
	it('toggles 500', async () => {
		...
		equal((await r0.json()).file, nameForAuto500('api/basic', 'GET'))
...
describe('Registering', () => {
	const temp500 = nameForAuto500('api/register', 'PUT')
