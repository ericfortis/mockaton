...
import { API, AUTO_500_COMMENT, DEFAULT_MOCK_COMMENT } from './ApiConstants.js'
...
describe('500', () => {
	it('autogenerated in-memory 500', async () => {
		await commander.select(`api/alternative${AUTO_500_COMMENT}.GET.500.empty`)
...
describe('Registering', () => {
	const temp500 = `api/register${AUTO_500_COMMENT}.PUT.500.empty`
